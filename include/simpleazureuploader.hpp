    ...
    namespace storage
    {
      ...
      public:
        UploadWorker(std::shared_ptr<AzureLocation> loc,
                     std::shared_ptr<::azure::storage_lite::blob_client> client) : loc(loc), stream(std::move(std::make_unique<std::stringstream>())), finished(true), stopped(false),
      ...
      public:
        ...
        SimpleAzureUploader(const std::string &account_name, const std::string &account_key,
